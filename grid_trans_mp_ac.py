...
lonmax=179.875
#计算起止时间
#print(datetime.datetime.strptime('1950-01-01','%Y-%m-%d')+datetime.timedelta(days=21915))
times=range(21915,25567) #2010-1-1 to 2019-12-31
