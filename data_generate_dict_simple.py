...
grid_acu_test=np.load('./Data/grid_acu_test_simple.npy',allow_pickle=True).item()
...
grid_cu_test=np.load('./Data/grid_cu_test_simple.npy',allow_pickle=True).item()
...
grid_acu=np.load('./Data/grid_acu_simple.npy',allow_pickle=True).item()
...
grid_cu=np.load('./Data/grid_cu_simple.npy',allow_pickle=True).item()
